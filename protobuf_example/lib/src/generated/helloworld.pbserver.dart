...
abstract class GreeterServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$0.HelloReply> sayHelloAgain($pb.ServerContext ctx, $0.HelloRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'SayHello': return $0.HelloRequest();
      case 'SayHelloAgain': return $0.HelloRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      ...
      case 'SayHelloAgain': return this.sayHelloAgain(ctx, request as $0.HelloRequest);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
